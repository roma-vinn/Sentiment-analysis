...
def plot_toy_data(algo_name, features, labels, thetas, save=False):
    """
    ...
    * algorithm - the string name of the learning algorithm used
    ...
    plt.show()
    if save:
        plt.savefig(algo_name + "_clf.png")


def plot_tune_results(algo_name, param_name, param_vals, acc_train, acc_val, save=False):
    """
    ...
    plt.show()
    if save:
        plt.savefig(algo_name + '_tune.png')
