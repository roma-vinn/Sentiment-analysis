...
def hinge_loss_full(feature_matrix, labels, theta, theta_0):
    ...
    """
    # 1/n Sum (K-th loss)
    z = (labels * (feature_matrix.dot(theta) + theta_0)).mean()
    hinge_loss = 0 if z >= 1 else 1-z
    return hinge_loss
# pragma: coderesponse end
...
def average_perceptron(feature_matrix, labels, T):
    ...
    avg_theta /= (T * feature_matrix.shape[0])
    avg_theta_0 /= (T * feature_matrix.shape[0])
...
def classify(feature_matrix, theta, theta_0):
    ...
    return classifier(feature_matrix.dot(theta) + theta_0)
# pragma: coderesponse end
...
def classifier_accuracy(
    ...
    training_data_prediction = classify(train_feature_matrix, train_theta, train_theta_0)
    accuracy_train = accuracy(training_data_prediction, train_labels)
    validation_data_prediction = classify(val_feature_matrix, train_theta, train_theta_0)
